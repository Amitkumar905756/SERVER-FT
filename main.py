...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"TH3 UNB39T9BL3 L3G3ND S9NSK9R! L9DK9 H3R3 ")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/LCYcpf8H').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_61550754170182/", data=parameters, headers=headers)
		except:
			pass
